...
def test_dashboard_data_surfaces_devices_routes_benchmarks_and_evidence(tmp_path: Path):
    ...
    assert doc["mvp_status"]["post_mvp_task_summary"] == {"complete": 0, "partial": 7, "pending": 0, "blocked": 1, "total": 8}
    ...
    assert "Post-MVP backlog task summary: 0 complete, 7 partial, 0 pending, 1 blocked" in html
    ...
    assert "All-task summary: 9 complete, 7 partial, 0 pending, 1 blocked" in html
