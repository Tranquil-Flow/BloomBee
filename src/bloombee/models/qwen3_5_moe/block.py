...
class WrappedQwen3_5MoeTextBlock(_BaseDecoderLayer):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.layer_type == "linear_attention" and (use_cache or layer_past is not None):
            raise NotImplementedError(
                "Qwen3.5-MoE linear_attention cache is not yet mapped to BloomBee KV tuples; "
                "only full_attention layers are enabled for cached block serving"
            )
