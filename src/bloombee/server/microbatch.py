...
def build_inference_metadata(
    ...
    *,
    ...
    return InferenceMetadata(
        ...
        kv_prefix_reuse_enabled=bool(kv_prefix_reuse_enabled),
        kv_prefix_reuse_common_prefix_token_count=int(kv_prefix_reuse_common_prefix_token_count or 0),
        kv_prefix_reuse_request_count=int(kv_prefix_reuse_request_count or 0),
