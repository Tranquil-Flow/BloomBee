...
python mvp_capabilities/termux_tiny_model_probe.py render \
  --out .local/phone/termux-tiny-model-probe.sh \
  --json
...
- Weighted engineering-build status from `mvp_status.py`:
  `██████████████████░░ 92%` built from the MVP-core plan, with claim boundary
